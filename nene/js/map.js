...
// 1. 검색리스트 생성
// 2. 검색리스트가 5개 이상이면 슬라이드 생성
// 3. 검색리스트가 5개일땐 hidden이 한번씩 추가 
// 4. 0 1 2 3 4 가 생성되었으면 0 1 2 3 , 1 2 3 4, 2 3 4 0, 3 4 0 1, 4 0 1 2 , 0 1 2 3 순서대로
// 5. 6개 이상이면 보여주는것을 제외한 나머지 부분에 hidden 생성 (반대로 모든 검색리스트에 hidden 속성을 준 다음 보여주고 싶은 부분만 active를 활성화시켜서 보여주게 한다.)
// 6. 한 방향으로 움직이게 한다.(자동)
// 7. 
